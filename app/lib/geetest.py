...
class GeetestLib(object):
    ...
    def _make_response_format(self, success=1, challenge=None, new_captcha=1):
        ...
        if new_captcha:
            string_format = {'success': success, 'gt': self.captcha_id, 'challenge': challenge, "new_captcha": True}
        else:
            string_format = {'success': success, 'gt': self.captcha_id, 'challenge': challenge, "new_captcha": False}
